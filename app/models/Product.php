...
class Category extends Model
{
    ...
    public function create(array $data):array
    {
        try{           
            ...
            $stmt->bindParam(":DESCRIPTON",$data['description']);
            $stmt->bindParam(":CODE",$data['code']);
            $stmt->bindParam(":QUANTIDY",$data['quantidy']);
            $stmt->bindParam(":UNITARY_VALUE",$data['unitary_value']);
            $stmt->bindParam(":VALUE",$data['value']);
            $stmt->bindParam(":VALIDITY",$data['validity']);
            $stmt->bindParam(":FK_CATEGORIES",$data['fk_categories']);
